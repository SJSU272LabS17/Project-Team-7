$(document).ready(function(){
	...
	$('#searchBar').focusout(function(){
		...
		{
			$('#searchBar').val('Search by Claim ID...')
		}
	})
		...
		success: function(d) {
			...
			for(var i = d.transactions.length-1; i >= 0 ; i--)
			{
				...
				if(obj.payload.indexOf("create_vehicle_log") == -1)
				{
					...
					if(type == "Create")
					{
						$('<tr class="retrievedRw" ><td class="smlBrk"></td><td style="width:1%; white-space:nowrap" class="transRw">['+v5cID+'] </td><td class="transRw" style="width:1%; white-space:nowrap"><span class="type" >Create</span><span class="message">: '+caller+'</span></td><td colspan="2" class="transRw">Create Claim</td><td class="transRw txtRight">'+timestamp+'</td><td class="smlBrk"></td></tr>').insertAfter('#insAft')
					}
					if(type == "Update")
					{
					...
					if(type == "Scrap")
					{
						$('<tr class="retrievedRw" ><td class="smlBrk"></td><td style="width:1%; white-space:nowrap" class="transRw">['+v5cID+'] </td><td class="transRw" style="width:1%; white-space:nowrap"><span class="type" >Settle</span><span class="message">: '+caller+'</span></td><td colspan="2" class="transRw">Settle Claim</td><td class="transRw txtRight">'+timestamp+'</td><td class="smlBrk"></td></tr>').insertAfter('#insAft')
					}	
					if(failed)
					{
...
{
	if($('#searchBar').val() == 'Search by Claim ID...')
	{
		$('#searchBar').val('')
	}
}
