        ...
        */
        ...
        if($('#selVhclsTbl tr').length >= 1 && $('#recipientInfo').html() != '') {
            ...
            for(let i = 0; i < $('#selVhclsTbl tr').length; i++) {
                spans += '<div class="loaderSpan" id="span'+(i+1)+'"><u>Claim '+(i+1)+'</u><br /><br /><span id="msg'+(i+1)+'Part1"></i>waiting...</i></span><br /><span id="msg'+(i+1)+'Part2"></span><br /><span id="msg'+(i+1)+'Part3"></span><br /><span id="msg'+(i+1)+'Part4"></span><br /></div>&nbsp;';
            }
            ...
            $('#selVhclsTbl tr').each(function() {
                ...
                $('#confTxt').html('Transaction committed to the blockchain. <br /><br />' +sendDets+'<br /><br />'+recDets+': '+$('.delName').html()+' (Account '+$('.accAddr').html()+')<br /><br />Claims: '+$('#selVhclsTbl tr').length);
            ...
            $('#failTransfer').show();
            $('#failTxt').html('You have not selected any claims to transfer.');
        } else {
            $('#failTransfer').show();
        ...
        */
        ...
        if($('#selVhclsTbl tr').length >= 1) {
            ...
            $('#selVhclsTbl tr').each(function() {
                ...
                $('#confTxt').html('Transaction committed to the blockchain. <br /><br />Settlement Authority: '+getCookie('user')+'<br /><br />Claims: '+$('#selVhclsTbl tr').length);
            ...
            $('#failTransfer').show();
            $('#failTxt').html('You have not selected any claims to settle.');
        }
    });
