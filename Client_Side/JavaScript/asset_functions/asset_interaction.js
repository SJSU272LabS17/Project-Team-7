...
function createAsset()
{
    ...
    $('#loaderMessages').html('<u>Creating Claim</u><br /><br /><span id="messages"></i>waiting...</i></span><br /></div>&nbsp;');
    ...
    xhr.onreadystatechange = function (){
        if(xhr.readyState === 4)
		{
            ...
            else
			{
                ...
                $('#confTxt').html('Created Claim: '+ JSON.parse(array[array.length - 1]).v5cID);
            }
        }
    };
...
function updateAsset(vin, make, model, colour, reg, v5cID, el)
{
	...
	*/
    ...
    bigData = [{'value':vin,'field':'VIN', 'title': 'VIN','v5cID':v5cID},{'value':make,'field':'make', 'title': 'Licence Plate Number','v5cID':v5cID},{'value':model,'field':'model', 'title': 'Accident Date','v5cID':v5cID},{'value':colour,'field':'colour', 'title': 'Amount','v5cID':v5cID},{'value':reg,'field':'reg', 'title': 'Policy ID','v5cID':v5cID}];
    increment=0;
